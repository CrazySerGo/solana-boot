...
print_help()
{
	...
	printf '\t%s\n' "--ramdisk-size-gb: Solana client ram disk size (default: '600')"
	...
	printf '\t%s\n' "--solana-version: Solana client version (default: '2.0.16')"
